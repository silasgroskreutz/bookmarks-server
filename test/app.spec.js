...
describe('Bookmarks Endpoints', () => {
  ...
  describe(`Unauthorized requests`, () => {
    ...
    it(`responds with 401 Unauthorize for GET /bookmarks`, () => {
      return supertest(app)
      .get('/bookmmarks')
    ...
    it('responds with 401 Unauthorized for POST /bookmarks', () => {
      return supertest(app)
        .post('bookmarks')
        .send({ title: 'test-title', url 'http://some.thing.com', rating: 2}
        .expect(401, { error: 'UNauthrozied request' }))
    })
